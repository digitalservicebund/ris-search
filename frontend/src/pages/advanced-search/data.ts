...
export const availablePublicFields: Field[] = [
  {
...
export const availablePublicFeatures: Feature[] = [
  {
    id: "und",
...
export const availableInternalFields: Field[] = [
  ...availablePublicFields,
  {
    label: "Fehler",
    aliases: ["FEHLER"],
    examples: ["FEHLER:true", "FEHLER:false"],
    types: ["case_law"],
  },
  {
    label: "Status",
  ...
  {
    label: "Rechtskraft",
    aliases: ["RECHTSKRAFT", "RK"],
    examples: [],
    types: ["case_law"],
  },
  {
    label: "Dokstelle",
    aliases: ["DOKUMENTATIONSSTELLE", "DOKSTELLE"],
    examples: [],
    types: ["case_law"],
  },
];

export const availableInternalFeatures: Feature[] = [
