    ...
    <div class="max-w-prose space-y-64">
      <section class="space-y-16">
        ...
        <ul class="list-bullet">
          <li>
            ...
            <NuxtLink class="ris-link1-regular" to="/cookie-einstellungen"
              >hier</NuxtLink
        ...
        <p>
          ...
          Informationen, die sich auf eine Person beziehen (z.B. Name, Adresse,
          Postanschrift, Telefonnummer, IP-Adresse) und die dazu genutzt werden
          können, die Identität einer Person zu erfahren; es sind alle
          ...
          Standortdaten oder zu einer Online-Kennung – identifiziert werden
          kann.
        </p>
        <dl class="[&_dt]:mt-32">
      ...
      <section>
        ...
        <p>
          ...
          Sicherheitsgründen verwendet sowie um die Webseiten zugänglich machen
          zu können (Bereitstellung und Optimierung einer funktionsfähigen
      ...
      <section>
        ...
        <p>
          Die Datenverarbeitung erfolgt auf Grundlage des Artikel 6 Abs. 1 UAbs.
          1 lit. e) und Abs. 3 lit. b) DS-GVO in Verbindung mit § 3 BDSG und ist
          zur Wahrnehmung unserer Aufgaben erforderlich.
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          (Artikel 6 Abs. 1 UAbs. 1 lit. a) DS-GVO in Verbindung mit § 25 Abs. 1
          TDDDG).
        </p>
      </section>
      <section>
        ...
        <p>
          ...
          Nutzungsdaten (siehe Abschnitt A) werden insofern regelmäßig für einen
          Zeitraum von 90 Tagen gespeichert. Daten aus der
        ...
        <p>
          ...
          löschen zu lassen. Dies ist allerdings nur dann möglich, wenn die ihn
          oder sie angehenden personenbezogenen Daten nicht mehr notwendig sind,
          rechtswidrig verarbeitet werden oder eine diesbezügliche Einwilligung
        ...
        <p>
          ...
          von der verantwortlichen Organisation zu erhalten, um sie ggf. an eine
