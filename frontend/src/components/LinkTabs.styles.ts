export const linkTabBase =
  "ris-body2-bold h-64 py-4 pl-20 pr-24 border-b-4 border-b-transparent outline-blue-800 outline-0 -outline-offset-4 focus-visible:outline-4 inline-flex items-center gap-8";

export const linkTabActive =
