...
import IcBaselineLocalLibrary from "~icons/ic/baseline-local-library";
import IcBaselineSignLanguage from "~icons/ic/baseline-sign-language";
...
.nav-link {
  @apply typo-link2-regular link-hover flex items-center gap-4 text-gray-900! aria-[current=page]:underline aria-[current=page]:decoration-2;
}
</style>
