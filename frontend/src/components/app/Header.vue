...
<template>
  <header id="top" class="border-b border-b-gray-400 bg-white print:hidden">
    <AppBanner />
    <nav class="wrapper flex flex-col gap-24 py-20" aria-label="Hauptmenü">
      <div class="flex items-center justify-between gap-16">
        ...
        <div class="float-end lg:hidden">
          <button
            class="typo-label-regular hover:typo-link-regular flex cursor-pointer items-center gap-8 outline-offset-4 outline-blue-800 focus-visible:outline-4"
            :aria-expanded="open"
