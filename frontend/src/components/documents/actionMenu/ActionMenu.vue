      ...
      <ul class="-mt-8">
        <li v-for="item in actions">
          <button
            v-if="item.disabled"
            type="button"
            class="typo-body flex w-full cursor-not-allowed items-center gap-8 py-12 text-left text-gray-800"
            disabled
          >
          ...
          <NuxtLink
            v-else-if="item.url"
            class="typo-body flex items-center gap-8 py-12 no-underline"
            external
          ...
          <button
            v-else
            type="button"
            class="typo-body flex w-full items-center gap-8 py-12 text-left"
            :data-attr="(item as ActionMenuItem).analyticsId"
