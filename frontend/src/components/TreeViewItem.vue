...
@scope ([role=treeitem]) to ([role=treeitem]) {
  ...
  * {
  ...
  .header {
    @apply text-gray-1000 typo-label1-compact-regular mb-2 flex gap-8 border-l-4 border-l-transparent py-8 pr-8 pl-12 hover:border-blue-500 hover:bg-blue-200 active:border-blue-800 active:bg-blue-300;
  }
  ...
  &[aria-expanded="true"] {
    ...
    .content .title {
      @apply typo-label1-compact-bold;
    }
  }
  ...
  &:not([aria-expanded]) {
    ...
    .content {
      ...
      .title {
        @apply typo-label1-compact-bold flex-none;
      }

      .subtitle {
        @apply typo-label1-compact-regular text-gray-1000;
      }
