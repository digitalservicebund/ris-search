...
class SitemapServiceTest {
    ...
    void testGenerateNormsSitemap() {
        ...
        when(norm.getDatePublished()).thenReturn("2025-08-06");
        InputStream is = sitemapService.generateNormsSitemap(List.of(norm));
    ...
    void testGenerateIndexXml() {
        InputStream is = sitemapService.generateIndexXml(2);
        String xml = new String(is.readAllBytes(), StandardCharsets.UTF_8);
