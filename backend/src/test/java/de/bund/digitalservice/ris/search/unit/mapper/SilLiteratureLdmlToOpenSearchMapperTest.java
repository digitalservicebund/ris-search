...
class SilLiteratureLdmlToOpenSearchMapperTest {

  private static final String VALID_XML =
      LoadXmlUtils.loadXmlAsString(Literature.class, "SILU000000001.akn.xml");
  ...
  void correctlyMapsAllAvailableFields() {
    ...
    var expected =
        Literature.builder()
            ...
            .handler(List.of("Bearbeiter, Foo"))
            ...
            .titelKurzformen(List.of("titel kurzform"))
            .sonstigeSachtitel(List.of("sonstiger titel"))
            .gesamttitel_angaben(List.of("gesamttitel, bandbezeichnung"))
