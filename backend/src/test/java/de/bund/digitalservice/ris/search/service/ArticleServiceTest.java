...
class ArticleServiceTest {
  ...
  @Test
  void getAllArticleVersionsDoesNotQueryRepositoryWhenDocumentNumberIsTooShort() {
    String expressionEli = "work/epression";
    String eId = "art-z1";
    String id = Article.buildId(expressionEli, eId);
        ...
        .thenReturn(
            Optional.of(
                Article.builder()
                    ...
                    .eId(eId)
                    .expressionEli(expressionEli)
                    .documentNumber("DKNR0E80B0026DKNE0001")
                    .build()));
    service.getAllArticleVersions(expressionEli, eId);

    verify(articlesRepository, never()).findAllByDocumentNumberStartingWith(any());
  }
}
