...
class SitemapServiceTest {
  ...
  void itWritesDocumentsToSitemaps() throws JAXBException {
    ...
    Sitemap sitemap = new Sitemap().setUrl(urls);
    String sitemapContent = EcliMarshaller.marshallSitemap(sitemap);
    ...
    verify(bucket).save(expectedSitemapPath, sitemapContent);
