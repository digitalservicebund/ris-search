...
class NlexWebserviceTest {
  ...
  void onTestQueryItReturnsThePlaceholder() {
    ...
    Assertions.assertEquals("placeholder", response.getQuery());
  }
  ...
  void onAboutConnectorItReturnsThePlaceholder() {
    ...
    Assertions.assertEquals("placeholder", response.getAboutConnectorResult());
  }

  @Test
  void onRequestItReturnsAPlaceholderResult() throws JAXBException {
    RequestResponse response = this.service.request(new Request());
    Assertions.assertEquals("placeholder", response.getRequestResult());
  }
}
