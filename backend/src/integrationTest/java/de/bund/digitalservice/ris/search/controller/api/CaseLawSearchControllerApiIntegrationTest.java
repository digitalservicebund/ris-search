...
import static de.bund.digitalservice.ris.search.controller.api.testData.CaseLawTestData.BESCHLUSS_COUNT;
import static de.bund.digitalservice.ris.search.controller.api.testData.CaseLawTestData.OTHER_COUNT;
import static de.bund.digitalservice.ris.search.controller.api.testData.CaseLawTestData.URTEIL_COUNT;
import static de.bund.digitalservice.ris.search.controller.api.testData.CaseLawTestData.matchMultipleTerm;
...
class CaseLawSearchControllerApiIntegrationTest extends ContainersIntegrationBase {
  ...
  void shouldReturnHighlightedSearchResults() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(jsonPath("$.member[0].textMatches[*].name").value(Matchers.hasItem("headline")))
        .andExpect(
