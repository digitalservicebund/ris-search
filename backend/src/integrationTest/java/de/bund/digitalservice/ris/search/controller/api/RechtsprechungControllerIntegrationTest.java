...
class RechtsprechungControllerIntegrationTest extends ContainersIntegrationBase {
  ...
  void shouldReturnSingleCaselawJson() throws Exception {
    ...
    mockMvc
        ...
        .andExpectAll(
            ...
            jsonPath("$.abweichendeAktenzeichen[0]").value("1 BvR 839, 899/96"),
            ...
            jsonPath("$.herkunftslaender[0]").value("Frankreich"),
            jsonPath("$.herkunftslaender[1]").value("Deutschland"),
            jsonPath("$.regionen[0]").value("NW"),
            jsonPath("$.tarifvertraege[0]").value("Stehende Bühnen"),
            jsonPath("$.kuendigungsgruende[0]").value("Straftat"),
            ...
            jsonPath("$.passivzitierungLiteraturSelbstaendig[0]").value("KSLS071671728"),
            jsonPath("$.aktivzitierungRechtsprechung[0]").value("BVRE100338409"),
            jsonPath("$.passivzitierungRechtsprechung[0]").value("JURE100074208"),
            jsonPath("$.aktivzitierungVerwaltungsvorschriften[0]").value("KSNR008561615"),
            ...
            jsonPath("$.sachgebiete[0]").value("fieldOfLaw test"),
            jsonPath("$.streitjahre[0]").value("2024"),
