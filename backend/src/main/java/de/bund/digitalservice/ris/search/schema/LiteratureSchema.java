...
public record LiteratureSchema(
    ...
    @Schema(description = "Bestellnummer", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Bearbeiter", requiredMode = Schema.RequiredMode.REQUIRED)
        List<String> editors,
    @Schema(description = "Begründer", requiredMode = Schema.RequiredMode.REQUIRED)
        List<String> founder,
    @Schema(description = "Herausgeber (Person)", requiredMode = Schema.RequiredMode.REQUIRED)
        List<String> publishers,
    @Schema(description = "Herausgeber (Institution)", requiredMode = Schema.RequiredMode.REQUIRED)
        List<String> publisherOrganizations,
    @Schema(description = "Verlag", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Hochschulvermerk", requiredMode = Schema.RequiredMode.REQUIRED)
        List<String> universityNotes,
    @Schema(description = "Teilbaende", requiredMode = Schema.RequiredMode.REQUIRED)
        List<String> volumes,
    @Schema(
