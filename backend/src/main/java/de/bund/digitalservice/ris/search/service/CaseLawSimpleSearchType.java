...
public class CaseLawSimpleSearchType implements SimpleSearchType {
  ...
  public static final Map<String, Float> FIELD_BOOSTS =
      Map.ofEntries(
          ...
          Map.entry(CaseLawDocumentationUnit.Fields.ENSUING_DECISIONS, convertOrderingToBoost(9)),
          ...
          Map.entry(CaseLawDocumentationUnit.Fields.PREVIOUS_DECISIONS, convertOrderingToBoost(8)),
