...
/** Controller class for handling search of Rechtsprechung (case law) documents. */
@Tag(name = "Rechtsprechung")
@RestController
@Profile({"dev", "e2e", "default", "staging", "uat", "test", "prototype"})
public class RechtsprechungSearchController {
  private final CaseLawService caseLawService;
  private final ServerConfig serverConfig;

  /**
   * Constructor for the RechtsprechungSearchController class.
   *
   ...
   */
  @Autowired
  public RechtsprechungSearchController(CaseLawService caseLawService, ServerConfig serverConfig) {
    this.caseLawService = caseLawService;
    this.serverConfig = serverConfig;
  }

  /**
   * Search for documents in the OpenSearch index with filters. Mirrors {@link
   * CaseLawSearchController#searchAndFilter}.
   *
