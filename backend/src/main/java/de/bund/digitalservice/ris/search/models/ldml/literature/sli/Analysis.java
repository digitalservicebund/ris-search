 ...
 *
 * <p>Fields: - otherReferences: A list of {@link
 * de.bund.digitalservice.ris.search.models.ldml.literature.sli.OtherReferences} objects
 * representing detailed references associated with the document. This is serialized under the
 * "otherReferences" XML tag within the Akoma Ntoso (AKN) namespace.
 */
@Getter
