...
public abstract class IndexService<T> {

  private static final Integer IMPORT_BATCH_SIZE = 1000;
  private final Logger logger;

  protected final Bucket bucket;
  protected final OpensearchRepository<T> repository;

  protected IndexService(Bucket bucket, OpensearchRepository<T> repository, Logger logger) {
    this.bucket = bucket;
