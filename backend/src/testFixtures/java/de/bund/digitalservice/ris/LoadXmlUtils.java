 ...
 *
 * <p>The XML files are organized under {@code src/testFixtures/resources/data/LDML/} in subfolders:
 *
 * <ul>
...
public class LoadXmlUtils {
  ...
  /**
   * Loads an XML test file from the appropriate folder under {@code
   * src/testFixtures/resources/data/LDML/} and returns its contents as a UTF-8 encoded string.
   *
