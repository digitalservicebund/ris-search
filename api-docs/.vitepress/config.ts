...
export default defineConfigWithTheme<ThemeConfig>({
  ...
  locales: {
    root: {
        ...
        description: "Technische Dokumentation und API-Referenz für den Zugriff auf Rechtsinformationen des Bundes.",
    }
},
  head: [
    [
    ...
    [
        ...
        {
            name: "description",
            content: "Technische Dokumentation und API-Referenz für den Zugriff auf Rechtsinformationen des Bundes."
        }
    ],
    [
        "meta",
  ...
  themeConfig: {
    ...
    posthog: {
      token: env.VITE_PUBLIC_POSTHOG_TOKEN,
